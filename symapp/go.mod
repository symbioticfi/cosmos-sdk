...
require cosmossdk.io/x/slashing v0.0.0-20240731202123-43dd23137e9d
...
// Here are the short-lived replace from the symapp
// Replace here are pending PRs, or version to be tagged
// replace (
// 	<temporary replace>
// )

// symapp on main always tests the latest extracted SDK modules importing the sdk
replace (
	...
	cosmossdk.io/x/symGov => ../x/symGov
...
// Below are the long-lived replace of the symapp
replace (
	// use cosmos fork of keyring
	github.com/99designs/keyring => github.com/cosmos/keyring v1.2.0
	// symapp always use the latest version of the cosmos-sdk
