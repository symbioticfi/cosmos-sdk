...
func (app *SymApp) setCustomAnteHandler() {
...
func (app *SymApp) InterfaceRegistry() codectypes.InterfaceRegistry {
...
func (app *SymApp) kvStoreKeys() map[string]*storetypes.KVStoreKey {
