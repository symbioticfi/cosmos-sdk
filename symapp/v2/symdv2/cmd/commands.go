...
func newApp[T transaction.Tx](
	...
	return serverv2.AppI[T](symapp.NewSymApp[T](logger, viper))
}
...
func appExport[T transaction.Tx](
	...
	var symApp *symapp.SymApp[T]
	if height != -1 {
		symApp = symapp.NewSymApp[T](logger, viper)

		if err := symApp.LoadHeight(uint64(height)); err != nil {
