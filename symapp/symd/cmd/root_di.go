...
import (
	...
	stakingv1 "cosmossdk.io/api/cosmos/symStaking/module/v1"
...
// NewRootCmd creates a new root command for symd. It is called once in the main function.
func NewRootCmd() *cobra.Command {
	...
	if err := depinject.Inject(
		depinject.Configs(symapp.AppConfig(),
