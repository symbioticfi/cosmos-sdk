...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "symd", "Home directory of the node's daemon configuration")
...
func initTestnetFiles(
	...
	// Update viper root since root dir become rootdir/node/symd
...
func startTestnet(cmd *cobra.Command, args startArgs) error {
	networkConfig := network.DefaultConfig(symapp.NewTestNetworkFixture)
