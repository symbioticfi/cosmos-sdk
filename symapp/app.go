...
import (
	...
	"cosmossdk.io/x/symGov"
	govkeeper "cosmossdk.io/x/symGov/keeper"
	govtypes "cosmossdk.io/x/symGov/types"
	govv1beta1 "cosmossdk.io/x/symGov/types/v1beta1"
	slashing "cosmossdk.io/x/symSlash"
...
var (
	_ runtime.AppI            = (*SymApp)(nil)
	_ servertypes.Application = (*SymApp)(nil)
)
...
func init() {
	var err error
	DefaultNodeHome, err = clienthelpers.GetNodeHomeDirectory(".symapp")
	if err != nil {
		panic(err)
	}
}
...
func NewSymApp(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		authzkeeper.StoreKey, group.StoreKey, pooltypes.StoreKey,
	...
	app.StakingKeeper = stakingkeeper.NewKeeper(
		...
		runtime.NewEnvironment(
			...
			logger.With(log.ModuleKey, "x/symStaking"),
	...
	app.SlashingKeeper = slashingkeeper.NewKeeper(runtime.NewEnvironment(runtime.NewKVStoreService(keys[slashingtypes.StoreKey]), logger.With(log.ModuleKey, "x/symSlash")),
	...
	*/
	...
	app.ModuleManager = module.NewManagerFromMap(map[string]appmodule.AppModule{
		...
		govtypes.ModuleName:            symGov.NewAppModule(appCodec, &app.GovKeeper, app.AuthKeeper, app.BankKeeper, app.PoolKeeper),
...
func (app *SymApp) setAnteHandler(txConfig client.TxConfig) {
...
func (app *SymApp) setPostHandler() {
...
// resources.
func (app *SymApp) Close() error {
	return app.UnorderedTxManager.Close()
}

// Name returns the name of the App
func (app *SymApp) Name() string { return app.BaseApp.Name() }

// PreBlocker application updates every pre block
func (app *SymApp) PreBlocker(ctx sdk.Context, _ *abci.FinalizeBlockRequest) error {
	return app.ModuleManager.PreBlock(ctx)
}

// BeginBlocker application updates every begin block
func (app *SymApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *SymApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (a *SymApp) Configurator() module.Configurator { // nolint:staticcheck // SA1019: Configurator is deprecated but still used in runtime v1.
	return a.configurator
}

// InitChainer application update at chain initialization
func (app *SymApp) InitChainer(ctx sdk.Context, req *abci.InitChainRequest) (*abci.InitChainResponse, error) {
...
func (app *SymApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// LegacyAmino returns symapp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *SymApp) LegacyAmino() *codec.LegacyAmino {
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *SymApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns symapp's InterfaceRegistry
func (app *SymApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns symapp's TxConfig
func (app *SymApp) TxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *SymApp) AutoCliOpts() autocli.AppOptions {
...
func (a *SymApp) DefaultGenesis() map[string]json.RawMessage {
...
func (app *SymApp) GetKey(storeKey string) *storetypes.KVStoreKey {
	return app.keys[storeKey]
}

// GetStoreKeys returns all the stored store keys.
func (app *SymApp) GetStoreKeys() []storetypes.StoreKey {
...
func (app *SymApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *SymApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *SymApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *SymApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *SymApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
