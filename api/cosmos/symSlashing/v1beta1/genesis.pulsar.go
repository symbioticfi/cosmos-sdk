...
func init() {
	file_cosmos_symSlash_v1beta1_genesis_proto_init()
	md_GenesisState = File_cosmos_symSlash_v1beta1_genesis_proto.Messages().ByName("GenesisState")
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.symSlash.v1beta1.GenesisState.params":
		return x.Params != nil
	case "cosmos.symSlash.v1beta1.GenesisState.signing_infos":
		return len(x.SigningInfos) != 0
	case "cosmos.symSlash.v1beta1.GenesisState.missed_blocks":
		return len(x.MissedBlocks) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.symSlash.v1beta1.GenesisState"))
		}
		panic(fmt.Errorf("message cosmos.symSlash.v1beta1.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.symSlash.v1beta1.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.symSlash.v1beta1.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_symSlash_v1beta1_genesis_proto_init()
	md_SigningInfo = File_cosmos_symSlash_v1beta1_genesis_proto.Messages().ByName("SigningInfo")
...
func (x *SigningInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SigningInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.symSlash.v1beta1.SigningInfo.address":
		return x.Address != ""
	case "cosmos.symSlash.v1beta1.SigningInfo.validator_signing_info":
		return x.ValidatorSigningInfo != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.symSlash.v1beta1.SigningInfo"))
		}
		panic(fmt.Errorf("message cosmos.symSlash.v1beta1.SigningInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SigningInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.symSlash.v1beta1.SigningInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SigningInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.symSlash.v1beta1.SigningInfo.address":
		panic(fmt.Errorf("field address of message cosmos.symSlash.v1beta1.SigningInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.symSlash.v1beta1.SigningInfo"))
		}
...
func (x *fastReflection_SigningInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.symSlash.v1beta1.SigningInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_symSlash_v1beta1_genesis_proto_init()
	md_ValidatorMissedBlocks = File_cosmos_symSlash_v1beta1_genesis_proto.Messages().ByName("ValidatorMissedBlocks")
...
func (x *ValidatorMissedBlocks) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_ValidatorMissedBlocks) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.symSlash.v1beta1.ValidatorMissedBlocks.address":
		return x.Address != ""
	case "cosmos.symSlash.v1beta1.ValidatorMissedBlocks.missed_blocks":
		return len(x.MissedBlocks) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.symSlash.v1beta1.ValidatorMissedBlocks"))
		}
		panic(fmt.Errorf("message cosmos.symSlash.v1beta1.ValidatorMissedBlocks does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ValidatorMissedBlocks) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.symSlash.v1beta1.ValidatorMissedBlocks does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ValidatorMissedBlocks) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.symSlash.v1beta1.ValidatorMissedBlocks.missed_blocks":
		...
		return protoreflect.ValueOfList(value)
	case "cosmos.symSlash.v1beta1.ValidatorMissedBlocks.address":
		panic(fmt.Errorf("field address of message cosmos.symSlash.v1beta1.ValidatorMissedBlocks is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.symSlash.v1beta1.ValidatorMissedBlocks"))
		}
...
func (x *fastReflection_ValidatorMissedBlocks) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.symSlash.v1beta1.ValidatorMissedBlocks", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_symSlash_v1beta1_genesis_proto_init()
	md_MissedBlock = File_cosmos_symSlash_v1beta1_genesis_proto.Messages().ByName("MissedBlock")
...
func (x *MissedBlock) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MissedBlock) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.symSlash.v1beta1.MissedBlock.index":
		return x.Index != int64(0)
	case "cosmos.symSlash.v1beta1.MissedBlock.missed":
		return x.Missed != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.symSlash.v1beta1.MissedBlock"))
		}
		panic(fmt.Errorf("message cosmos.symSlash.v1beta1.MissedBlock does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MissedBlock) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.symSlash.v1beta1.MissedBlock does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MissedBlock) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.symSlash.v1beta1.MissedBlock.index":
		panic(fmt.Errorf("field index of message cosmos.symSlash.v1beta1.MissedBlock is not mutable"))
	case "cosmos.symSlash.v1beta1.MissedBlock.missed":
		panic(fmt.Errorf("field missed of message cosmos.symSlash.v1beta1.MissedBlock is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.symSlash.v1beta1.MissedBlock"))
		}
...
func (x *fastReflection_MissedBlock) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.symSlash.v1beta1.MissedBlock", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: cosmos/symSlash/v1beta1/genesis.proto
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_cosmos_symSlash_v1beta1_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (*SigningInfo) Descriptor() ([]byte, []int) {
	return file_cosmos_symSlash_v1beta1_genesis_proto_rawDescGZIP(), []int{1}
}
...
func (*ValidatorMissedBlocks) Descriptor() ([]byte, []int) {
	return file_cosmos_symSlash_v1beta1_genesis_proto_rawDescGZIP(), []int{2}
}
...
func (*MissedBlock) Descriptor() ([]byte, []int) {
	return file_cosmos_symSlash_v1beta1_genesis_proto_rawDescGZIP(), []int{3}
}
...
var File_cosmos_symSlash_v1beta1_genesis_proto protoreflect.FileDescriptor

var file_cosmos_symSlash_v1beta1_genesis_proto_rawDesc = []byte{
	0x0a, 0x28, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x73, 0x79, 0x6d, 0x53, 0x6c, 0x61, 0x73,
	...
	0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x73, 0x79, 0x6d, 0x53, 0x6c, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x73, 0x79,
	...
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x73, 0x79, 0x6d, 0x53, 0x6c, 0x61, 0x73, 0x68, 0x69,
	...
	,
	...
	0xb0, 0x2a, 0x01, 0x52, 0x14, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x69,
	0x67, 0x6e, 0x69, 0x6e, 0x67, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xad, 0x01, 0x0a, 0x15, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x4d, 0x69, 0x73, 0x73, 0x65, 0x64, 0x42, 0x6c, 0x6f,
	0x63, 0x6b, 0x73, 0x12, 0x3b, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01,
	...
	0x12, 0x57, 0x0a, 0x0d, 0x6d, 0x69, 0x73, 0x73, 0x65, 0x64, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b,
	0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	...
	,
}

var (
	file_cosmos_symSlash_v1beta1_genesis_proto_rawDescOnce sync.Once
	file_cosmos_symSlash_v1beta1_genesis_proto_rawDescData = file_cosmos_symSlash_v1beta1_genesis_proto_rawDesc
)

func file_cosmos_symSlash_v1beta1_genesis_proto_rawDescGZIP() []byte {
	file_cosmos_symSlash_v1beta1_genesis_proto_rawDescOnce.Do(func() {
		file_cosmos_symSlash_v1beta1_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_symSlash_v1beta1_genesis_proto_rawDescData)
	})
	return file_cosmos_symSlash_v1beta1_genesis_proto_rawDescData
}

var file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cosmos_symSlash_v1beta1_genesis_proto_goTypes = []interface{}{
	(*GenesisState)(nil),          // 0: cosmos.symSlash.v1beta1.GenesisState
	(*SigningInfo)(nil),           // 1: cosmos.symSlash.v1beta1.SigningInfo
	(*ValidatorMissedBlocks)(nil), // 2: cosmos.symSlash.v1beta1.ValidatorMissedBlocks
	(*MissedBlock)(nil),           // 3: cosmos.symSlash.v1beta1.MissedBlock
	(*Params)(nil),                // 4: cosmos.symSlash.v1beta1.Params
	(*ValidatorSigningInfo)(nil),  // 5: cosmos.symSlash.v1beta1.ValidatorSigningInfo
}
var file_cosmos_symSlash_v1beta1_genesis_proto_depIdxs = []int32{
	4, // 0: cosmos.symSlash.v1beta1.GenesisState.params:type_name -> cosmos.symSlash.v1beta1.Params
	1, // 1: cosmos.symSlash.v1beta1.GenesisState.signing_infos:type_name -> cosmos.symSlash.v1beta1.SigningInfo
	2, // 2: cosmos.symSlash.v1beta1.GenesisState.missed_blocks:type_name -> cosmos.symSlash.v1beta1.ValidatorMissedBlocks
	5, // 3: cosmos.symSlash.v1beta1.SigningInfo.validator_signing_info:type_name -> cosmos.symSlash.v1beta1.ValidatorSigningInfo
	3, // 4: cosmos.symSlash.v1beta1.ValidatorMissedBlocks.missed_blocks:type_name -> cosmos.symSlash.v1beta1.MissedBlock
...
func init() { file_cosmos_symSlash_v1beta1_genesis_proto_init() }
func file_cosmos_symSlash_v1beta1_genesis_proto_init() {
	if File_cosmos_symSlash_v1beta1_genesis_proto != nil {
		return
	}
	file_cosmos_symSlash_v1beta1_slashing_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_symSlash_v1beta1_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_symSlash_v1beta1_genesis_proto_goTypes,
		DependencyIndexes: file_cosmos_symSlash_v1beta1_genesis_proto_depIdxs,
		MessageInfos:      file_cosmos_symSlash_v1beta1_genesis_proto_msgTypes,
	}.Build()
	File_cosmos_symSlash_v1beta1_genesis_proto = out.File
	file_cosmos_symSlash_v1beta1_genesis_proto_rawDesc = nil
	file_cosmos_symSlash_v1beta1_genesis_proto_goTypes = nil
	file_cosmos_symSlash_v1beta1_genesis_proto_depIdxs = nil
}
