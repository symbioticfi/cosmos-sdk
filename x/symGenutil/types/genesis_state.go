...
// DefaultGenesisState returns the symGenutil module's default genesis state.
...
// GetGenesisStateFromAppState gets the symGenutil genesis state from the expected app state
...
// SetGenesisStateInAppState sets the symGenutil genesis state within the expected app state
