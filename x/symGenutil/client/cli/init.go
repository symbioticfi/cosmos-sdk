...
func InitCmd(mm genesisMM) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			nodeID, _, err := symGenutil.InitializeNodeValidatorFilesFromMnemonic(config, mnemonic, consensusKey)
			if err != nil {
				return err
			}
			...
			if err = symGenutil.ExportGenesisFile(appGenesis, genFile); err != nil {
