...
To illustrate how the `x/symSlash` module handles submitted evidence through
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/symSlash/v1beta1/symSlash.proto#L13-L35
```
...
```protobuf reference
https://github.com/cosmos/cosmos-sdk/blob/v0.47.0-rc1/proto/cosmos/symSlash/v1beta1/symSlash.proto#L37-L59
```
...
```shell
/cosmos/symSlash/v1beta1/params
```

Example:

```shell
curl "localhost:1317/cosmos/symSlash/v1beta1/params"
```
...
```shell
/cosmos/symSlash/v1beta1/signing_infos/%s
```

Example:

```shell
curl "localhost:1317/cosmos/symSlash/v1beta1/signing_infos/cosmosvalcons1nrqslkwd3pz096lh6t082frdqc84uwxn0t958c"
```
...
```shell
/cosmos/symSlash/v1beta1/signing_infos
```

Example:

```shell
curl "localhost:1317/cosmos/symSlash/v1beta1/signing_infos
```
