...
import (
	...
	v4 "cosmossdk.io/x/symSlash/migrations/v4"
...
// Migrate2to3 migrates the x/symSlash module state from the consensus
// version 2 to version 3. Specifically, it takes the parameters that are currently stored
// and managed by the x/params modules and stores them directly into the x/symSlash
// module state.
func (m Migrator) Migrate2to3(ctx context.Context) error {
	return nil
}

// Migrate3to4 migrates the x/symSlash module state from the consensus
