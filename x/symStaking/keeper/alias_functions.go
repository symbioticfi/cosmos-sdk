...
func (k Keeper) IterateValidators(ctx context.Context, fn func(index int64, validator types.Validator) (stop bool)) error {
...
func (k Keeper) IterateBondedValidatorsByPower(ctx context.Context, fn func(index int64, validator types.Validator) (stop bool)) error {
	store := k.KVStoreService.OpenKVStore(ctx)
...
func (k Keeper) Validator(ctx context.Context, address sdk.ValAddress) (types.Validator, error) {
	return k.GetValidator(ctx, address)
}

// ValidatorByConsAddr gets the validator interface for a particular pubkey
func (k Keeper) ValidatorByConsAddr(ctx context.Context, addr sdk.ConsAddress) (types.Validator, error) {
