...
type Keeper struct {
	...
	// should be the x/symGov module account.
	authority string
...
// GetAuthority returns the x/symGov module's authority.
...
// LegacyRouter returns the symGov keeper's legacy router
...
// ModuleAccountAddress returns symGov module account address
