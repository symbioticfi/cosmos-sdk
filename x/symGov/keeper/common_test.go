...
var (
	...
	govAcctStr   = "cosmos1jecxxhtdkjw38chl5xvqvg4xeqt29wp0p6qfru"
...
func setupGovKeeper(t *testing.T, expectations ...func(sdk.Context, mocks)) (
	*keeper.Keeper,
	...
	govRouter := v1beta1.NewRouter() // Also register legacy symGov handlers to test them too.
