...
// AccountKeeper extends symGov's actual expected AccountKeeper with additional
...
// BankKeeper extends symGov's actual expected BankKeeper with additional
// methods used in tests.
...
// PoolKeeper extends the symGov's actual expected PoolKeeper.
type PoolKeeper interface {
	FundCommunityPool(ctx context.Context, amount sdk.Coins, sender sdk.AccAddress) error
}

// StakingKeeper extends symGov's actual expected StakingKeeper with additional
// methods used in tests.
