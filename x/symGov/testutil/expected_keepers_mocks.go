...
// Source: x/symGov/testutil/expected_keepers.go
...
func (m *MockStakingKeeper) IterateBondedValidatorsByPower(arg0 context.Context, arg1 func(int64, stakingTypes.Validator) bool) error {
	m.ctrl.T.Helper()
