...
func ConvertToLegacyProposal(proposal v1.Proposal) (v1beta1.Proposal, error) {
	...
	if len(msgs) != 1 {
		return v1beta1.Proposal{}, sdkerrors.ErrInvalidType.Wrap("can't convert a symGov/v1 Proposal to symGov/v1beta1 Proposal when amount of proposal messages not exactly one")
	}
	...
	// this is to support clients that have not yet (properly) use symGov/v1 endpoints
