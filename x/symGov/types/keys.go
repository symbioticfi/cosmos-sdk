...
const (
	...
	// StoreKey is the store key string for symGov
	StoreKey = ModuleName

	// RouterKey is the message route for symGov
...
var (
	...
	MessageBasedParamsKey        = collections.NewPrefix(51) // MessageBasedParamsKey stores the message based symGov params.
)
