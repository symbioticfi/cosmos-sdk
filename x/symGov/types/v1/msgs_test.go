...
func TestMsgSubmitProposal_GetSignBytes(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			`{"type":"cosmos-sdk/v1/MsgSubmitProposal","value":{"initial_deposit":[],"messages":[{"type":"cosmos-sdk/v1/MsgVote","value":{"option":1,"proposal_id":"1","voter":"cosmos1w3jhxap3gempvr"}}],"proposal_type":1,"summary":"Proposal for a governance vote msg","title":"symGov/MsgVote"}}`,
		},
		{
			"MsgSend",
