...
import (
	...
	symGov "cosmossdk.io/x/symGov"
	"cosmossdk.io/x/symGov/client/cli"
	govclitestutil "cosmossdk.io/x/symGov/client/testutil"
...
func (s *CLITestSuite) SetupSuite() {
	s.encCfg = testutilmod.MakeTestEncodingConfig(codectestutil.CodecOptions{}, symGov.AppModule{})
...
func (s *CLITestSuite) TestNewCmdSubmitProposal() {
	...
	validProp := fmt.Sprintf(`
	{
		"messages": [
			{
				"@type": "/cosmos.symGov.v1.MsgExecLegacyContent",
				"authority": "%s",
				"content": {
					"@type": "/cosmos.symGov.v1beta1.TextProposal",
