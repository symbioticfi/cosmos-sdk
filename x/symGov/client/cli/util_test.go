	...
	tests := []struct {
		...
		// Combo tests.
		{
			...
			args: []string{
				...
				argTitle, "Simple symGov Prop Title",
				argSummary, "This is just a test summary on a simple symGov prop.",
			},
			exp: &v1.MsgSubmitProposal{
				InitialDeposit: cz("56depcoin"),
				Proposer:       fromAddrStr,
				Metadata:       "my proposal is cool",
				Title:          "Simple symGov Prop Title",
				Summary:        "This is just a test summary on a simple symGov prop.",
			},
		},
		{
